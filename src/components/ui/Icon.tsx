...
// Simple SVG icon set used across the dashboard
...
const paths: Record<IconName, React.ReactNode> = {
  ...
  tools: (
    <>
      <path strokeLinecap="round" strokeLinejoin="round" d="M14.7 6.3a4 4 0 0 0-5.4 5.4L3 18v3h3l6.3-6.3a4 4 0 0 0 5.4-5.4l-3.2 3.2-2.2-2.2 2.4-4z" />
    </>
  ),
  "refresh-cw": (
    <>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.51 9a9 9 0 0 1 14.14-3.36L23 10M1 14l5.35 4.36A9 9 0 0 0 20.49 15" />
    </>
  ),
  grid: (
    <>
  ...
  trello: (
    <>
      ...
      <rect x="7" y="8" width="4" height="8" rx="1" ry="1" />
      <rect x="13" y="8" width="4" height="5" rx="1" ry="1" />
    </>
  ),
  calendar: (
    <>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 14h3M13 14h3M8 17h3" />
    </>
  ),
  clock: (
    <>
...
export function Icon({ name, className = "w-[18px] h-[18px]" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
