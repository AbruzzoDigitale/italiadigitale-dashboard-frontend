 ...
 *
 * Scriverci dentro davvero vorrebbe dire gestire due stati della stessa ricerca — uno
 * qui e uno nel pannello — e perderne uno al primo carattere. Il clic apre il palette
 * e si scrive lì, che è anche dove si leggono i risultati.
 *
...
export function OracleSearchBar({ onOpen }: { onOpen: () => void }) {
  ...
  return (
    ...
    >
      ...
      <span className="flex-1 text-left text-[12px] truncate">Cerca o chiedi…</span>
      <kbd
