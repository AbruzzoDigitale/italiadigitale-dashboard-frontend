...
const TABS: NotifTabKey[] = ["task", "richieste", "contratti", "comunicazioni", "monitoraggi", "sale", "rimborsi", "cassaforte"];
...
export function useNotifications(hiddenTabs: NotifTabKey[] = []) {
  ...
  const counts = useMemo(() => {
    const c: Record<NotifTabKey, number> = { task: 0, richieste: 0, contratti: 0, comunicazioni: 0, monitoraggi: 0, sale: 0, rimborsi: 0, cassaforte: 0 };
