...
import { monthLabel, type BillingItem, type BillingStatus } from "../utils/billing";
...
export function FatturazionePage() {
  ...
  const { items, stats, isLoading, error, refetch, setStatus } = useBilling(companyId);
  ...
  return (
    <div className="mx-auto w-full max-w-[1600px] animate-fadeIn px-10 py-8 pb-20">
      ...
      {/* Avviso placeholder backend FIC */}
      ...
      {companyId == null ? (
        <EmptyState
          ...
          message="Seleziona un’azienda dalla barra in alto per vedere le voci da fatturare."
        />
      ) : isLoading ? (
        ...
        <EmptyState
          ...
          message="Quando una lavorazione collegata a un contratto viene completata, comparirà qui."
        />
      ) : (
